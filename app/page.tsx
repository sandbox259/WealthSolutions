...
const organizationSchema = {
  ...
  "@type": "Organization",
  "@id": "https://niveshnirnaysolutions.in/#organization",
  "name": "Nivesh Nirnay Solutions",
  "url": "https://niveshnirnaysolutions.in/",
  "logo": {
    "@type": "ImageObject",
    "url": "https://niveshnirnaysolutions.in/niveshlogo.png"
  }
}
...
const websiteSchema = {
  "@context": "https://schema.org",
  "@type": "WebSite",
  "@id": "https://niveshnirnaysolutions.in/#website",
  "url": "https://niveshnirnaysolutions.in/",
  "name": "Nivesh Nirnay Solutions",
  "alternateName": "Nivesh Nirnay",
  "publisher": {
    "@id": "https://niveshnirnaysolutions.in/#organization"
  }
}
    ...
    <div>
      ...
      <section className="relative text-white min-h-[70vh] md:min-h-[85vh] flex items-center overflow-hidden">
        <div className="absolute inset-0">
          <Image
            src="/chart.jpg"
            alt="Nivesh Nirnay Solutions team"
            fill
            priority
        ...
        <div className="relative max-w-7xl mx-auto px-6 lg:px-8">
          <div className="max-w-3xl">
            ...
            <p className="text-sm md:text-base text-[#D4AF37] font-semibold uppercase tracking-widest mb-4 md:mb-6">
            ...
            <h1 className="font-heading text-3xl sm:text-4xl md:text-6xl font-semibold tracking-tight leading-tight mb-4 md:mb-6">
              Investment Education & Market Learning
            </h1>

            <p className="text-base sm:text-lg text-gray-100 leading-relaxed max-w-2xl mb-10 md:mb-12">
              Helping individuals develop financial awareness, market understanding
              and disciplined decision-making through structured educational programs
            ...
            <FadeIn>
              <div>
                ...
                <p className="text-[#1F3A5F] font-semibold mb-5 md:mb-6">
                  Nivesh Nirnay Solutions is a financial education and market
                  learning organization committed to helping individuals understand
                  various segments of the securities market through structured
                  educational frameworks.
                </p>

                <div className="space-y-5 md:space-y-6 text-[#1F3A5F]/80 leading-relaxed max-w-xl">
                  <p>
                    Our focus is not on shortcuts or speculation, but on developing
                    knowledge, discipline and practical market understanding that
                    supports long-term financial growth.
                  </p>

                  <p>
                    Our motto "Learn First. Invest Later." reflects our commitment
                    to building informed investors who understand the markets before
                    deploying capital.
                  </p>

                  <p>
                    We believe that informed decisions come from education,
        ...
        <FadeIn>
          <div className="max-w-3xl mx-auto text-center px-6">
            ...
            <p className="text-gray-200 mb-8 md:mb-10">
              Discover our comprehensive programs designed to build your
              investment knowledge and market expertise.
            </p>
