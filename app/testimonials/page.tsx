        ...
        <div className="max-w-4xl mx-auto px-6 lg:px-8">
          <FadeIn>
            <div className="relative">
              ...
              <div className="bg-gradient-to-br from-[#1F3A5F] to-[#2D4A6F] text-white rounded-lg p-8 md:p-12 mb-8 shadow-lg">
              ...
              <div className="flex justify-between items-center">
                <button
                  ...
                  className="bg-[#D4AF37] text-[#1F3A5F] p-3 rounded-full hover:bg-[#E8CFA0] transition-colors"
          ...
          {/* Testimonial Stats */}
          <FadeIn delay={0.2}>
            <div className="grid md:grid-cols-3 gap-8 mt-16 pt-16 border-t border-[#E8E4DF]">
              <div className="text-center">
                <p className="font-heading text-4xl font-bold text-[#1F3A5F] mb-2">1000+</p>
                <p className="text-[#1F3A5F]/80">Students Empowered</p>
              </div>
              <div className="text-center">
                <p className="font-heading text-4xl font-bold text-[#1F3A5F] mb-2">4.9/5</p>
                <p className="text-[#1F3A5F]/80">Average Rating</p>
              </div>
              <div className="text-center">
                <p className="font-heading text-4xl font-bold text-[#1F3A5F] mb-2">95%</p>
                <p className="text-[#1F3A5F]/80">Completion Rate</p>
              </div>
            </div>
          </FadeIn>
        </div>
            ...
            {testimonials.map((testimonial, index) => (
              <FadeIn key={index} delay={index * 0.1}>
                <div className="bg-white border border-[#E8E4DF] rounded-lg p-8">
                  ...
                  <p className="text-[#1F3A5F]/80 text-sm leading-relaxed mb-6">
                    "{testimonial.text}"
                  </p>
                  <div>
                    ...
                    <p className="text-[#1F3A5F]/60 text-xs">
        ...
        <FadeIn>
          <div className="max-w-3xl mx-auto text-center px-6">
            ...
            <p className="text-gray-200 mb-8 md:mb-10">
              Start your transformation journey with expert mentorship and structured education.
            </p>
            <Link
              href="/contact"
